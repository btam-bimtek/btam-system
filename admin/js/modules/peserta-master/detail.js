...
function _tabBtn(tab, label) {
  const active   = 'tab-btn px-4 py-2 text-sm font-medium border-b-2 text-[#2dd4bf] border-[#2dd4bf] transition-colors';
...
function _switchTab(tab, app) {
  ...
  app.querySelectorAll('.tab-btn').forEach(btn => {
    ...
    btn.className = isActive
      ? 'tab-btn px-4 py-2 text-sm font-medium border-b-2 text-[#2dd4bf] border-[#2dd4bf] transition-colors'
