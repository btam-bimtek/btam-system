...
const NAV_ITEMS = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: 'Unit Kompetensi', icon: 'badge',    href: '/master-uk' },
      { label: 'Alumni',           icon: 'history',  href: '/alumni' }
    ]
  },
  {
    section: 'Rekrutmen',
    items: [
      { label: 'Siklus Seleksi',   icon: 'clipboard', href: '/rekrutmen/siklus' },
      { label: 'Calon Peserta',    icon: 'users',     href: '/rekrutmen/calon' },
      { label: 'Seleksi Tertulis', icon: 'document',  href: '/rekrutmen/tertulis' },
      { label: 'Penentuan',        icon: 'badge',     href: '/rekrutmen/penentuan' }
    ]
  },
  {
    section: 'Analitik',
  ...
  sidebar.innerHTML = `
    ...
    <div class="px-5 py-5 border-b border-gray-800">
      <div class="flex items-center gap-3">
        ...
        <div>
          <p class="text-sm font-semibold text-white leading-none">SI-SABAT</p>
